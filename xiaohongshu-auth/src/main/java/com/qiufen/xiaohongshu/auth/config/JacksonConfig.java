//package com.qiufen.xiaohongshu.auth.config;
//
...
//        javaTimeModule.addDeserializer(YearMonth.class, new YearMonthDeserializer(DateConstants.DATE_FORMAT_Y_M));        objectMapper.registerModule(javaTimeModule);
//        // 初始化jsonUtil中的objectMapper
